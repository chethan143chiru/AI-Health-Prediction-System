...
import heroImage from '../assets/images/ai_health_hologram_1780391849950.png';
      ...
      <section className="py-32 bg-slate-950/50 border-t border-white/5 px-6">
         <div className="max-w-7xl mx-auto flex flex-col items-center text-center space-y-12">
            ...
            <div className="flex flex-wrap justify-center gap-10">
               <a href="tel:+919900399845" className="flex items-center gap-3 text-slate-500 hover:text-blue-500 transition-colors">
                  <Phone className="w-5 h-5" /> +91 99003 99845
               </a>
               <a href="mailto:contact@health.ai" className="flex items-center gap-3 text-slate-500 hover:text-blue-500 transition-colors">
                  <Mail className="w-5 h-5" /> contact@health.ai
               </a>
               <a href="https://www.google.com/maps/search/?api=1&query=Pandavapura" target="_blank" rel="noreferrer" className="flex items-center gap-3 text-slate-500 hover:text-blue-500 transition-colors">
